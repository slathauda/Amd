...
<script src="<?= base_url(); ?>assets/js/dashboard.js" type="text/javascript"></script><!-- OTHER SCRIPTS INCLUDED ON THIS PAGE - END -->
        ...
        <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
            <div class="page-title">
                <div class="pull-left hidden-xs">
                    <ol class="breadcrumb">
                        <li class="active"><a href="<?= base_url(); ?>user"><i class="fa fa-home"></i><strong>Home</strong></a></li>
                        <!--<li class="active"><strong>User Dashboard</strong></li>-->
                    </ol>
                </div>
            </div>
        </div>
...
/* SWEET NOTIFICATION MESSAGE SHOW */
if (sizeof($notfymsg) > 0) { ?>
    <script>toastr.info('You have <?= sizeof($notfymsg); ?> messages ..');</script>
    <?php
} ?>
<!-- END SWEET NOTIFICATION MESSAGE COUNT SHOW -->
