...
<ul class="breadcrumb">
    ...
    <li class="active"> Shop Vouchers</li>
</ul>
<!-- END BREADCRUMB -->
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><strong>Shop Vouchers </strong></h3>
                </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-xs-12 text-right">
                                    <button type="button form-control  " onclick="srchShopVou()"
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="col-md-4 col-xs-12 control-label">Shop Name</label>
...
<script>
    ...
    function abc12() {
        pymode();
        document.getElementById('pyac').value = 0;
        document.getElementById('pymo').value = 0;
    }

    function srchShopVou() {                                                       // Search btn
    ...
    function viewVou(vuid, typ) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                document.getElementById("pynm").innerHTML = response['shpdt'][0]['spnm'];
                ...
                for (var a = 0; a < len2; a++) {
                    // IF TOPUP LOAN
                    if (response['lndt'][a]['prva'] != 0) {
                        var tp = "<span class='label label-info' title='Topup Loan'>T</span>";
                        if (response['lndt'][a]['chmd'] == 2) {
                            var pyamt = +response['lndt'][a]['loam'] - (+response['lndt'][a]['tpbal'] + +response['lndt'][a]['docg'] + +response['lndt'][a]['incg'] );
                        } else {
                            var pyamt = +response['lndt'][a]['loam'] - +response['lndt'][a]['tpbal'];
                        }
                    } else {
                        var tp = "";
                        if (response['lndt'][a]['chmd'] == 2) {
    ...
    function vouPrint(id, mode) {
        ...
        } else if (mode == 5) {     // SHOP VOUCHER
            window.open('<?= base_url(); ?>user/shopVouPrint/' + id, 'popup', 'width=800,height=600,scrollbars=no,resizable=no');
            srchShopVou();
        }
    }
    ...
    function vouReprint(auid, mode, lnid) {
        ...
        }else if (mode == 5) {     // SHOP VOUCHER REPRINT
            window.open('<?= base_url(); ?>user/shopVouPrint/' + auid, 'popup', 'width=800,height=600,scrollbars=no,resizable=no');
            srchShopVou();
        }
    }
