...
<ul class="breadcrumb">
    ...
    <li>Loan Module</li>
    <li class="active">Loan Dual Approval</li>
</ul>
<!-- END BREADCRUMB -->
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><strong> Loan Dual Approval </strong></h3>
                                ...
                                <div class="col-md-6 col-xs-6">
                                    <select class="form-control" name="stat" id="stat">
                                        ...
                                        foreach ($stainfo as $stat) {
                                            if($stat->stid == 19){
                                                echo "<option value='$stat->stid' selected>$stat->stnm</option>";
                                            }else{
                                                echo "<option value='$stat->stid' disabled>$stat->stnm</option>";
                                            }
                                        }
                                        ?>
                                    </select>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-xs-12 text-right">
                                    <button type="button form-control  " onclick="srchAppLoan()"
                                    ...
                                    <div class="col-md-6" id="prdBaseEdt">  <!-- product base -->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8 col-xs-6">
                                                <select class="form-control" name="fcamtEdt" id="fcamtEdt" readonly=""
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-4 col-xs-6 control-label">No of Rental</label>
                                            <div class="col-md-8 col-xs-6">
                                                <select class="form-control" name="duraEdt" id="duraEdt" readonly=""
...
//                },
    ...
    function srchAppLoan() {                                                       // Search btn
        ...
        if (brn == '0') {
            ...
            $('#dataTbLoan').DataTable({
                ...
                "ajax": {
                    url: '<?= base_url(); ?>user/getDualApprvl',
                    type: 'post',
                    data: {
                        brn: brn,
                        exc: exc,
...
//                    document.getElementById('docu').value = '0';
    ...
    function calInstal(typ) {
        ...
        document.getElementById('lnprim').value = numeral(mm).format('0.0000');
        document.getElementById('dyn_ttlint').value = numeral(aa).format('0.0000');
    ...
    function edtLoan(auid, typ) {
        if (typ == 'edt') {
            ...
            $('#hed').text("Dual Approval Loan");
            $('#btnNm').text("Dual Approval");
    ...
    $("#loan_edt").submit(function (e) { // edit form
        ...
        if ($("#loan_edt").valid()) {
            if (func == 1) {
                swal({title: "", text: "Contact System Admin", type: "warning"},
                    function () {
                        // location.reload();
                    });
            } else if (func == 2) {
                swal({
                        title: "Are you sure Dual Approval ?",
                        text: "",
                        type: "warning",
                        ...
                        if (isConfirm) {
                            ...
                            $.ajax({
                                ...
                                success: function (data, textStatus, jqXHR) {
                                    ...
                                    srchAppLoan();
                                    document.getElementById("edtBtn").disabled = false;
                                    swal({title: "", text: "Loan Dual Approval success!", type: "success"},
                                        function () {
                                            // location.reload();
                                        });
                                },
                                error: function (data, textStatus, jqXHR) {
                                    document.getElementById("edtBtn").disabled = false;
                                    swal({
                                        title: "Loan Dual Approval Failed",
    ...
    function rejecLoan(id) {
        swal({
            ...
            function (isConfirm) {
                if (isConfirm) {
                    $.ajax({
                        url: '<?= base_url(); ?>user/rejDualAppLoan',
                        type: 'post',
                        data: {
                            id: id
                        },
