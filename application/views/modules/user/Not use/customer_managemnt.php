                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8 col-xs-12">
                                                <input type="email" class="form-control" placeholder="Email" id="emil"
                                                       name="emil"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8 col-xs-12">
                                                <label class="switch">
                                                    <input id="bsms" name="bsms" type="checkbox" value="1" checked/>No
                                                    <span></span>
                                                </label> Yes
                                            </div>
                                        </div>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8 col-xs-12">
                                                <input type="email" class="form-control" placeholder="Email"
                                                       id="adv_emil_edt" name="adv_emil_edt"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 col-xs-12 control-label">SMS Sending</label>
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                for (var i = 0; i < len; i++) {
                    ...
                    document.getElementById("emil_edt").value = response[i]['emil'];
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                for (var i = 0; i < len; i++) {
                    ...
                    document.getElementById("adv_emil_edt").value = response[i]['emil'];
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                for (var i = 0; i < len; i++) {
                    ...
                    document.getElementById("vew_emil").innerHTML = response[i]['emil'];
                    if (response[i]['smst'] == 1) {
