...
<ul class="breadcrumb">
    ...
    <li>Loan Module</li>
    <li class="active"> Loan Early Settlement</li>
</ul>
<!-- END BREADCRUMB -->
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><strong> Loan Early Settlement</strong></h3>
                </div>
                <div class="panel-body">
                    ...
                    <div class="row">
                        <h3 class="text-title"><span class="fa fa-thumbs-o-up"></span> Facility Closing </h3>
                        ...
                        <form class="form-horizontal" id="loan_stl" name="loan_stl" action="" method="post">
                            <div class="panel-body form-horizontal">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="col-md-4  col-xs-6 control-label">Pay Date</label>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-4  col-xs-6 control-label">Paying Branch</label>
                                        <div class="col-md-6 col-xs-6">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-4  col-xs-6 control-label">Rebate For Payments </label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-6">
                                            <select class="form-control" name="pytp" id="pytp"
                                                    onchange="chckBtn(this.value,'pytp')">
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (len > 0) {
                        ...
                        document.getElementById("ovpe").innerHTML = numeral(response[0]['avcr']).format('0,0.00');
                        ...
                        document.getElementById("pyamt").value = setVal;
                        document.getElementById("amut").value = setVal;
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        ...
                        var jqXHR = jQuery.ajax({
                            type: "POST",
                            url: "<?= base_url(); ?>User/addLnSettlment",
                            data: $("#loan_stl").serialize(),
                            dataType: 'json',
                            success: function (data) {
                                swal({title: "", text: "Loan settlement success", type: "success"},
                                    function () {
                                        location.reload();
                                    }
                                );
                            ...
                            error: function () {
                                swal({title: "Loan settlement Failed", text: "Contact system admin", type: "error"},
                                    function () {
                                        location.reload();
                                    }
                                );
