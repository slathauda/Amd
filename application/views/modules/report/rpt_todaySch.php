...
<ul class="breadcrumb">
    ...
    <li>Report Module</li>
    <li>Sales Report</li>
    <li class="active"> Center Schedule Arrears</li>
</ul>
<!-- END BREADCRUMB -->
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><strong> Center Schedule Arrears </strong></h3>
                </div>
                <div class="panel-body ">
                    <form id="rpt_tdarr" name="rpt_tdarr" class="form-horizontal" method="post">
                        <div class="row ">
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <label class="col-md-4 col-xs-6 control-label">Center Day</label>
                                    <div class="col-md-6 col-xs-6">
                                        <select class="form-control" name="cndy" id="cndy">
                                            <option value="-"> Select Day</option>
                                            <?php
                                            foreach ($collinfo as $coll) {
                                                echo "<option value='$coll->dyid'>$coll->cday</option>";
                                            }
                                            ?>
                                        </select>
                                    </div>
...
<script>
    ...
    $().ready(function () {
        ...
        $("#rpt_tdarr").validate({  // Product loan validation
            rules: {
                brch: {
                    required: true,
                    notEqual: '0'
    ...
    $("#srch").click(function (e) {
        ...
        if ($("#rpt_tdarr").valid()) {
            ...
            $('#dataTbTdarr').DataTable({
                ...
                "ajax": {
                    url: '<?= base_url(); ?>report/searchTdarrs',
                    type: 'post',
                    data: {
                        brn: brn,
                        ofc: ofc,
    ...
    $("#print").click(function (e) {
        ...
        if ($("#rpt_tdarr").valid()) {
            ...
            w.location.href = '<?= base_url(); ?>report/printTodyArres/' + brn + '/' + ofc + '/' + cnt + '/' + cndy + '/' + prtp;
    ...
    $("#excel").click(function (e) {
        ...
        if ($("#rpt_tdarr").valid()) {
            ...
            var w = window.open('about:blank', '_blank');
            w.location.href = '<?= base_url(); ?>Excelrpt/todyArres/' + brn + '/' + ofc + '/' + cnt + '/' + cndy + '/' + prtp;
