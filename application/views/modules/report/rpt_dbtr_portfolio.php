...
<ul class="breadcrumb">
    ...
    <li>Report Module</li>
    <li>Sales Report</li>
    <li class="active"> Debtor Portfolio Report</li>
</ul>
<!-- END BREADCRUMB -->
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><strong> Debtor Portfolio Report</strong></h3>
                </div>
                <div class="panel-body ">
                    <form id="rpt_dbt_port" name="rpt_dbt_port" class="form-horizontal" method="post">
                        <div class="row ">
                            <div class="col-md-4">
                                ...
                                <div class="table-responsive">
                                    <table class="table datatable table-bordered table-striped table-actions"
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center">MATUARITY</th>
...
<script>
    ...
    $().ready(function () {
        ...
        $("#rpt_dbt_port").validate({  // Product loan validation
            rules: {
                brch: {
                    required: true,
                    notEqual: '0'
    ...
    $("#srch").click(function (e) {
        ...
        if ($("#rpt_dbt_port").valid()) {
            ...
            $('#dataTbDbtPortfo').DataTable().clear();
            $('#dataTbDbtPortfo').DataTable({
                "destroy": true,
                "cache": false,
                "processing": true,
                ...
                "columnDefs": [
                    ...
                    {className: "text-center", "targets": [0, 4, 9, 11, 13, 20, 22, 24,25]},
                    {className: "text-right", "targets": [0, 10, 11, 12, 14, 15, 16, 17, 18, 19, 21,23]},
                ...
                "ajax": {
                    url: '<?= base_url(); ?>report/srchDbtPort',
                    type: 'post',
                    data: {
                        brn: brn,
                        prtp: prtp,
    ...
    $("#excel").click(function (e) {
        ...
        if ($("#rpt_dbt_port").valid()) {
            ...
            w.location.href = '<?= base_url(); ?>excelrpt/debtorPortfo/' + brn + '/' + ofcr + '/' + cen + '/' + prtp ;
