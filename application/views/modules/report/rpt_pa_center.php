...
<ul class="breadcrumb">
    ...
    <li>Report Module</li>
    <li>Pa Report</li>
    <li class="active"> Center Wise Pa Report</li>
</ul>
<!-- END BREADCRUMB -->
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><strong> Center Wise Pa Report</strong></h3>
                </div>
                <div class="panel-body ">
                    <form id="rpt_paCnt" name="rpt_paCnt" class="form-horizontal" method="post">
                        <div class="row ">
                            <div class="col-md-4">
...
<script>
    ...
    $().ready(function () {
        ...
        $("#rpt_paCnt").validate({  // Product loan validation
            rules: {
                brch: {
                    required: true,
                    notEqual: '0'
