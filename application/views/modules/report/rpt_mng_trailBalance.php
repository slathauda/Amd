        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><strong> Trail Balance </strong></h3>
                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-xs-6">
                                        <input type="text" class="form-control datepicker"
                                               placeholder="" id="asdt" name="asdt" value="<?= date("Y-m-d") ?>"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
...
<script>
    ...
    $("#print").click(function (e) {
        ...
        if ($("#rpt_gl").valid()) {
            ...
            w.location.href = '<?= base_url(); ?>report/printTrailBal/' + brn + '/' + asdt ;
