...
<ul class="breadcrumb">
    ...
    <li class="active"> Voucher Report</li>
</ul>
<!-- END BREADCRUMB -->
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><strong> Voucher Report </strong></h3>
                </div>
                <div class="panel-body ">
                    <form id="rpt_vouc" name="rpt_vouc" class="form-horizontal" method="post">
                        <div class="row ">
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-xs-6">
                                        <select class="form-control" name="vutp" id="vutp">
                                            ...
                                            <option value="2">Incash Viucher</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-xs-12 text-right">
                                        ...
                                        <div class="button btn-group pull-right" style="padding-left: 3px">
                                            <button class="btn btn-sm btn-danger dropdown-toggle" data-toggle="dropdown"><i class="fa fa-bars"></i> Export</button>
                                            <ul class="dropdown-menu">
                                                <li><a href="#" id="print"><img src='<?= base_url(); ?>assets/dist/img/icons/pdf.png' width="24"/> PDF</a></li>
                                                <li><a href="#" id="excel"><img src='<?= base_url(); ?>assets/dist/img/icons/xls.png' width="24"/> EXCEL</a></li>
                                            </ul>
                                        </div>
                            ...
                            <div class="panel-body panel-body-table" style="padding:10px;">
                                <div class="table-responsive">
                                    <table class="table datatable table-bordered table-striped table-actions"
                                           id="dataTbVouc" width="100%">
                                        <thead>
                                        <tr>
                                            <th class="text-center">NO</th>
                                            <th class="text-center">BRCH</th>
                                            <th class="text-center">VOUC NO</th>
...
<script>
    ...
    $().ready(function () {
        ...
        $("#rpt_vouc").validate({  // Product loan validation
            rules: {
                brch: {
                    required: true,
                    notEqual: '0'
            ...
            messages: {
                ...
                vutp: {
                    ...
                    notEqual: "Please select voucher type"
                },
            }
        });
    });
        ...
        if ($("#rpt_vouc").valid()) {
            ...
            $('#dataTbVouc').DataTable({
                ...
                "columnDefs": [
                    ...
                    {className: "text-right", "targets": [0, 6, 7,9]},
                ...
                "ajax": {
                    url: '<?= base_url(); ?>report/searchVouc',
                    type: 'post',
                    data: {
                        brn: brn,
                        ofc: ofc,
    ...
    $("#print").click(function (e) {
        ...
        if ($("#rpt_vouc").valid()) {
            ...
            w.location.href = '<?= base_url(); ?>report/printVouc/' + brn + '/' + ofc + '/' + cnt + '/' + frdt + '/' + todt + '/' + vutp;
