            ...
            <div class="page-title">
                <div class="pull-left hidden-xs">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><strong>Permission Management</strong></li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-12">
            <section class="box ">
                <header class="panel_header">
                    <h3 class="title pull-left">Permission Management</h3>
                </header>
                    ...
                    <div class="row form-horizontal">
                        <div class="col-md-4">
                            <div class="form-group form-horizontal">
                                <label class="col-md-6 col-xs-6 control-label">Permission Type</label>
                            ...
                            <div class="form-group" id="usr" style="display: none">
                                <label class="col-md-6 col-xs-6 control-label">User</label>
                                <div class="col-md-6 col-xs-6">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="col-md-3 col-xs-6 control-label">User Level</label>
                                <div class="col-md-6 col-xs-6">
                        ...
                        <div class="col-md-4">
                            <div class="form-group" id="brn" style="display: none">
                                <label class="col-md-3 col-xs-6 control-label">Branch</label>
                                <div class="col-md-6 col-xs-6">
            ...
            <section class="box ">
                <div class="content-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="" id="taba" style="display: none">
                                <ul class="nav nav-tabs primary" role="">
                                    <li class="active">
                                        <a href="#tab-1" data-toggle="tab">Basic Permission</a>
                                    </li>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table datatable table-bordered table-striped table-actions"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th class="text-center" style="color: red">Re Active
                                                            </th>
