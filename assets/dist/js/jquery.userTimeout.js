		...
		var modal = function () {
			...
			if (modalUI === 'bootstrap') {
				...
				if (options.timer === true) {
					footer = $('<div class="modal-footer"><button type="button" class="btn btn-success" data-dismiss="modal">Stay Logged In </button></div>'); /* (<span id="countdowntimer">' + seconds + '</span>) */
					countDown(seconds);
				} else {
					footer = $('<div class="modal-footer"><button type="button" class="btn btn-success" data-dismiss="modal">Stay Logged In</button></div>');
				}
